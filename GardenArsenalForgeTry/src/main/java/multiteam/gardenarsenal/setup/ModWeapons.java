...
public class ModWeapons extends BowItem {
    public ModWeapons(Properties builder) {
        super(builder);
    }
            ...
            if (!ammoStack.isEmpty() || hasInfinity) {
                ...
                if (!((double)velocity < 0.1D)) {
                    if (!worldIn.isRemote) {
                        ...
                        arrowEntity.func_234612_a_(playerentity, playerentity.rotationPitch, playerentity.rotationYaw, 0.0F, velocity * 3.0F, 1.0F);
