...
public class VillagerProfessions {
    ...
    public static final RegistryObject<VillagerProfession> GARDEN_SOLDIER_COMMANDER = Registration.PROFESSIONS.register("garden_soldier_commander", () -> new VillagerProfession("garden_soldier_commander", new PointOfInterestType("garden_soldier_commander_poi", ImmutableSet.of(ModBlocks.GARDEN_SOLDIER_COMMANDER_POI.get().getDefaultState()), 5, 40), COMMANDER_ITEMS, ImmutableSet.of(ModBlocks.GARDEN_SOLDIER_COMMANDER_POI.get()), SoundEvents.ENTITY_VILLAGER_WORK_WEAPONSMITH));
    ...
    public static final DeferredRegister<VillagerProfession> PROFESSIONS = DeferredRegister.create(ForgeRegistries.PROFESSIONS, GardenArsenalMod.MOD_ID);
     .register("garden_soldier_commander
