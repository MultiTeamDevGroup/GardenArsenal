...
public class CocoaShotgun extends ModWeapons {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(new TranslationTextComponent("tooltip.gardenarsenal.cocoa_bean_shotgun_desc").copyRaw().mergeStyle(TextFormatting.BLUE));
    ...
    public void onPlayerStoppedUsing(ItemStack bowStack, World worldIn, LivingEntity entityLiving, int timeLeft) {
        if (entityLiving instanceof PlayerEntity) {
            ...
            playerentity.getCooldownTracker().setCooldown(this, 50);
                    ...
                    if (!worldIn.isRemote) {
                        ...
                        for (int x = -1; x < 2; x++){
                            for (int y = -1; y < 2; y++){
                                ...
                                weaponProjectile.func_234612_a_(playerentity, playerentity.rotationPitch+x*4, playerentity.rotationYaw+y*4, 0.0F, 2.0F, 1.0F);
