...
public class GardenArsenalBlocks {
    ...
    public static final RegistrySupplier<Block> BARRICADE_SURVIVALIST = registerWithItem("survivalist_barricade", () -> new Block(BlockProperties.of(Material.WOOD)), new Item.Properties().tab(GardenArsenalItems.MISC));
    public static final RegistrySupplier<Block> BARRICADE_MAKER = registerWithItem("maker_barricade", () -> new Block(BlockProperties.of(Material.STONE)), new Item.Properties().tab(GardenArsenalItems.MISC));
    public static final RegistrySupplier<Block> BARRICADE_CONSTRUCTION = registerWithItem("construction_barricade", () -> new Block(BlockProperties.of(Material.HEAVY_METAL)), new Item.Properties().tab(GardenArsenalItems.MISC));
