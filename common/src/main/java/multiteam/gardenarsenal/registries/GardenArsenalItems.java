...
public class GardenArsenalItems {
    ...
    public static final RegistrySupplier<Item> CARROT_RIFLE = ITEMS.register("carrot_rifle", () -> new CarrotRifle(new Item.Properties().defaultDurability(500).arch$tab(GardenArsenalCreativeModeTabs.WEAPONS)));
    public static final RegistrySupplier<Item> POTATO_BAZOOKA = ITEMS.register("potato_bazooka", () -> new PotatoBazooka(new Item.Properties().defaultDurability(500).arch$tab(GardenArsenalCreativeModeTabs.WEAPONS)));
    public static final RegistrySupplier<Item> COCOA_BEAN_SHOTGUN = ITEMS.register("cocoa_bean_shotgun", () -> new CocoaShotgun(new Item.Properties().defaultDurability(500).arch$tab(GardenArsenalCreativeModeTabs.WEAPONS)));
    public static final RegistrySupplier<Item> SEED_PISTOL = ITEMS.register("seed_pistol", () -> new SeedPistol(new Item.Properties().defaultDurability(500).arch$tab(GardenArsenalCreativeModeTabs.WEAPONS)));
    public static final RegistrySupplier<Item> SUGAR_CANE_SNIPER = ITEMS.register("sugar_cane_sniper", () -> new SugarcaneSniper(new Item.Properties().defaultDurability(500).arch$tab(GardenArsenalCreativeModeTabs.WEAPONS)));
    ...
    public static final RegistrySupplier<Item> GLIMMERING_REVOLVER = ITEMS.register("glimmering_revolver", () -> new GlimmeringRevolver(new Item.Properties().arch$tab(GardenArsenalCreativeModeTabs.WEAPONS).defaultDurability(500)));
