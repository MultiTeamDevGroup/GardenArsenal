...
public class GardenArsenalExpectPlatformImpl {
    ...
    public static void registerPoiType(PoiType poi) {
        var key = Registry.POINT_OF_INTEREST_TYPE.getResourceKey(poi);
        PoiTypesInvoker.invokeRegisterBlockStates(Registry.POINT_OF_INTEREST_TYPE.getHolderOrThrow(key.get()));
    }
}
