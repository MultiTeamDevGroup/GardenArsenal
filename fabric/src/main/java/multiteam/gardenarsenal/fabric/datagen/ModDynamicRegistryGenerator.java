...
public class ModDynamicRegistryGenerator extends FabricDynamicRegistryProvider {
    public ModDynamicRegistryGenerator(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
    ...
    public String getName() {
        return "Garden Arsenal Dynamic Registry Generator";
    }
}
